 ...
 * //----------------CREATE-------------------------------
 * 
 * @Transactional public void createProduct(Product product) {
 * this.hibernateTemplate.save(product);
 * 
 * }
 * 
 * //--------------------LOAD-ALL-------------------------- public List<Product>
 * getProducts() { List<Product> products =
 * this.hibernateTemplate.loadAll(Product.class); return products; }
 * 
 * //-----------------------DELETE-----------------------
 * 
 * @Transactional public void deleteProduct(int pid) { Product p =
 * this.hibernateTemplate.load(Product.class, pid);
 * this.hibernateTemplate.delete(p); }
 * 
 * //---------------------------GET single product---------
 * 
 * public Product getSingleProduct(int pid) { return
